...
此目录保存所有由总控发给用户测试的 APK。APK 被 Git 忽略，但不得覆盖或删除；对应证据记录在 `_manager/releases`。
...
- `app/v1.0.0/test.001/EnglishApp-v1.0.0-test.001-a3b5e2a.apk`（自动测试与签名构建通过；等待用户覆盖安装验收）
