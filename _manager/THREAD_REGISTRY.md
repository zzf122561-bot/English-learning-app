...
| 功能1 | 当前：`01a02f8c-2b77-7360-9d8f-56d7faa11773`；交接前：`01a024d0-fa64-7382-96e0-920fec364fc5` | `app-feature` | 独立 worktree；总控管理 | `feature-01-word-memory` | `C:\Users\zzf86\.codex\worktrees\d2f2\Codex_EnglishApp` / `codex/1` | 2026-08-24：按新格式汇报 v0.2.0 就绪；主动补报读取范围偏差 |
...
- 功能1随后主动披露误读 `C:\Users\zzf86\.codex\memories\MEMORY.md` 第 50–59 行。该内容未用于改动，但超出授权范围；总控已补充禁止读取全局 memory 的明确规则，待二次确认后关闭此审计项。
