...
三个功能里程碑均已完成并经总控增量审查；v0.1.0 已进入 App v0.3.0 test.001，但实机发现 WebView 主文档误拦截。v0.1.1 仅修复该问题：严格应用生成的 `data:text/html...` 主框架交给 WebView，data 子框架、外部主框架和非法 MDD 路径仍封锁。v0.1.1 已由总控集成并生成签名 test.002，当前状态为 `awaiting_test.002_device_retest`；没有 v0.1.1 设备证据，不能宣称实机修复。证据见 `WEBVIEW_MAIN_DOCUMENT_FIX_AUDIT.md`，完整交接见 `MILESTONE_3_HANDOFF.md`，解析来源见 `MILESTONE_1B_AUDIT.md`，许可证原文见 `THIRD_PARTY_NOTICES.md`。
